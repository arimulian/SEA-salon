    ...
    <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
        <div class="flex flex-col md:flex-row">
            <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                <h3 class="font-bold text-2xl">SEA salon</h3>
                <p class="text-gray-400">Welcome to the SEA salon, where trust and comfort are priorities.</p>
            </div>

            <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                <h5 class="uppercase tracking-wider font-semibold text-gray-500">Services</h5>
                <ul class="mt-4">
                    <li class="mt-2"><a href="{{route('service')}}" title="" class="opacity-75
                    hover:opacity-100">Haircut &
                            Style</a></li>
                    <li class="mt-2"><a href="{{route('service')}}" title="" class="opacity-75
                    hover:opacity-100">Manicure &
                            Padicure</a></li>
                    <li class="mt-2"><a href="{{route('service')}}" title="" class="opacity-75 hover:opacity-100">Facial
                            Treatments</a></li>
                </ul>
            </div>
            ...
            <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                ...
                <p class="text-sm text-gray-400 mt-12">© {{ date('Y') }} SEAsalon <br class="hidden lg:block"> by Arimul
                </p>
            </div>
        </div>
    </footer>
